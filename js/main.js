/**
 * Cybulski Bygg Malerservice AS - Main JavaScript
 * Warm, professional interactions for painting service website
 */
        ...
        if (value) {
            switch (fieldName) {
                ...
                case 'message':
                    if (value.length < 10) {
                        isValid = false;
                        errorMessage = 'Vennligst beskriv prosjektet mer detaljert (minst 10 tegn)';
                    }
                    break;
            }
        }
